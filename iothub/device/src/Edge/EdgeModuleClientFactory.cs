    ...
    internal class EdgeModuleClientFactory
    {
        ...
        private async Task<ModuleClient> CreateInternalClientFromEnvironmentAsync()
        {
            ...
            else
            {
                ...
                var authMethod = new ModuleAuthenticationWithHsm(signatureProvider, deviceId, moduleId, generationId, (int)_options.SasTokenTimeToLive.TotalSeconds, _options.SasTokenRenewalBuffer);
